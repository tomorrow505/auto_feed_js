...
function buildHDSkySmallDescr(meta: TorrentMeta): string {
    const title = meta.title || '';
    const descr = meta.description || '';
...
function applyHDSkyOptions(labels: Record<string, boolean>, smallDescr: string, description: string) {
 ...
 */
function fillHDSkySelects(meta: TorrentMeta): void {
    try {
...
function buildPTerDescr(meta: TorrentMeta): string {
